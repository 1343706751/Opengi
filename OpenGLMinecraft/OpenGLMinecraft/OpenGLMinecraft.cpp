...
int main()
{
	...
	Shader screenShader("VertexSource2.vert", "FragmentSource2.frag");
	...
	//生成图片使用glTexImage2DMultisample来替代glTexImage2D
	...
	//glRenderbufferStorage的调用改为glRenderbufferStorageMultisample 创建多重采样渲染缓冲对象
