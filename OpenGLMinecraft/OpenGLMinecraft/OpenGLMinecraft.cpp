...
int main()
{
	...
	//In GL_CLAMP_TO_BORDER To Set Up 
	...
	Trans = glm::scale(Trans, glm::vec3(2.0f, 1.0f, 1.2f));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix4fv(glGetUniformLocation(ourShader.ID, "transform"), 1, GL_TRUE, glm::value_ptr(Trans));
